...
function append_files_to_list(path, files) {
  ...
  for (i in files) {
    ...
    if (item.mimeType == "application/vnd.google-apps.folder") {
      ...
      } else if (item.mimeType == "application/x-rar" || item.mimeType == "application/zip" || item.mimeType == "application/x-archive" || item.mimeType == "application/x-tar" || item.mimeType == "application/gzip" || item.mimeType == "application/bzip2" || item.mimeType == "application/x-xz" || item.mimeType == "application/x-7z-compressed" || item.mimeType == "application/x-rar-compressed" || item.mimeType == "application/x-gtar"){
